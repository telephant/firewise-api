...
exports.getFlowStats = exports.deleteFlow = exports.updateFlow = exports.createFlow = exports.getFlow = exports.getFlows = void 0;
...
const getFlows = async (req, res) => {
    try {
        ...
        const { page = '1', limit = '20', type, start_date, end_date, asset_id, } = req.query;
...
const createFlow = async (req, res) => {
    try {
        const userId = req.user.id;
        const { type, amount, currency, from_asset_id, to_asset_id, category, date, description, tax_withheld, recurring_frequency, flow_expense_category_id, metadata, } = req.body;
...
const updateFlow = async (req, res) => {
    try {
        ...
        if (tax_withheld !== undefined)
            updates.tax_withheld = tax_withheld ? parseFloat(tax_withheld) : null;
        if (recurring_frequency !== undefined)
            updates.recurring_frequency = recurring_frequency || null;
